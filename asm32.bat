...
rem  SET VSHOME statement (near line 148 in this file).                                                    
rem                                                                    
...
rem  (5) Carlos Vasquez, Universidad Tecnologica de El Salvador                      
rem                                                                    
rem  Update History: 
rem  -------------------------------------------------------------------
...
rem   25/06/2010: Make portable for fun, by Carlos V�squez Espino
rem               run in any media (usb, cd, dvd), in "\Irvine" directory.
rem   03/02/2011: By Carlos V�squez Espino
rem               run in any media (usb, cd, dvd) and any directory.
rem   24/04/2016: By Carlos V�squez Espino
rem               Permit compile files ina any path
rem   07/05/2020: By Carlos V�squez Espino
rem               If compile was successful, run it!!!
rem   23/01/2021: By Carlos V�squez Espino
...
rem         By: Carlos Edgardo V�squez Espino, El Salvador   
rem -----------------------------------------------------------------
SET DRIVE=#
